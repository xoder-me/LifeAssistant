...
//		linePaint.setStrokeWidth(mLineSTROKEWidth);
		...
		flowPaint.setTextSize(DensityUtils.sp2px(context, 25));

		leftPaint = new Paint();
		leftPaint.setColor(mCircleColor);
		leftPaint.setStyle(Paint.Style.FILL);
		leftPaint.setAntiAlias(true);
		leftPaint.setTextSize(DensityUtils.sp2px(context, 14));
...
//		canvas.drawLine(mScreenWidth * 3 / 8, mScreenHeight * 5 / 8, mScreenWidth * 5 / 8, mScreenHeight * 5 / 8, linePaint);
		...
		// 每次onDraw时c都会自增
		c = (1L + c);
		float f1 = mScreenHeight * (1.0F - mWaterLevel);
